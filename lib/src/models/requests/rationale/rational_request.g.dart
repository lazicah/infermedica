...
part of 'rational_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<RationaleRequest> _$rationaleRequestSerializer =
    new _$RationaleRequestSerializer();

class _$RationaleRequestSerializer
    implements StructuredSerializer<RationaleRequest> {
  @override
  final Iterable<Type> types = const [RationaleRequest, _$RationaleRequest];
  @override
  final String wireName = 'RationaleRequest';

  @override
  Iterable<Object?> serialize(Serializers serializers, RationaleRequest object,
  ...
  @override
  RationaleRequest deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new RationaleRequestBuilder();
...
class _$RationaleRequest extends RationaleRequest {
  @override
  final SexType sex;
  @override
  ...
  factory _$RationaleRequest(
          [void Function(RationaleRequestBuilder)? updates]) =>
      (new RationaleRequestBuilder()..update(updates)).build();

  _$RationaleRequest._(
      {required this.sex,
      required this.age,
      this.evidence,
      this.extras,
      this.evaluatedAt})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(sex, 'RationaleRequest', 'sex');
    BuiltValueNullFieldError.checkNotNull(age, 'RationaleRequest', 'age');
  }

  @override
  RationaleRequest rebuild(void Function(RationaleRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RationaleRequestBuilder toBuilder() =>
      new RationaleRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RationaleRequest &&
        sex == other.sex &&
        age == other.age &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('RationaleRequest')
          ..add('sex', sex)
          ..add('age', age)
...
class RationaleRequestBuilder
    implements Builder<RationaleRequest, RationaleRequestBuilder> {
  _$RationaleRequest? _$v;
  ...
  RationaleRequestBuilder();

  RationaleRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _sex = $v.sex;
  ...
  @override
  void replace(RationaleRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RationaleRequest;
  }

  @override
  void update(void Function(RationaleRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$RationaleRequest build() {
    _$RationaleRequest _$result;
    try {
      _$result = _$v ??
          new _$RationaleRequest._(
              sex: BuiltValueNullFieldError.checkNotNull(
                  sex, 'RationaleRequest', 'sex'),
              age: age.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'RationaleRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
